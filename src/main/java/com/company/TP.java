...
public class TP {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(c.getEspace(espaces).toString());
    }
    ...
    public static Map<String, Integer> dimensions_espace_occupation(List<Form> formes){
        ...
        for(Form f: formes){
            if(f instanceof Rect){
                ...
                item_dimensions = get_dimensions_of_rectangle((Rect)f);
    ...
    public static Map<String, Double> get_dimensions_of_rectangle(Rect r){
        Map<String, Double> item_dimensions = new HashMap<>();
